namespace AWE {
    ...
    public abstract class ACyclicIndexIterator<T> : ICyclicIndexIterator<T> {
        ...
        // If the iterated object is empty, the default value for cycles should be 1.
        // This helps prevent index out of bounds exceptions if the iterator used in
        //   a for loop that checks cycle count as an exit criteria.
        protected int defaultCycles => ((this.count > 0) ? 0 : 1);
